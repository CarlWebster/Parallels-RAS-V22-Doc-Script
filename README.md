...
You do NOT have to run this script on a server running RAS. This script was developed and run from Windows 11, WIndows Server 2022, and Windows Server 2025 VMs.
